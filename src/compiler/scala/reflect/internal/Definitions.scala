...
//      case _ => tpe
    ...
    lazy val ClassManifestClass  = getRequiredClass("scala.reflect.ClassManifest")
    lazy val ClassManifestModule = getRequiredModule("scala.reflect.ClassManifest")
    ...
    lazy val ArrayManifestClass  = getRequiredClass("scala.reflect.ArrayManifest")

    @deprecated("Use ClassManifestClass", "2.10.0")
    def PartialManifestClass  = getRequiredClass("scala.reflect.ClassManifest")
    @deprecated("Use ClassManifestModule", "2.10.0")
    def PartialManifestModule = getRequiredModule("scala.reflect.ClassManifest")
