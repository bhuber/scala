...
import util.CompilerClassProvider
import util.ClassPath._
...
trait Platform {
  ...
  /** The compiler class provider. */
  def classProvider: CompilerClassProvider
   ...
   */
  def needCompile(classRep: ClassRep): Boolean
}
